...
class Emotion(QMainWindow):
    ...
    def screenshot(self):
      ...
      cv2.imwrite(f"output/{self.bounding_box.xmin*self.bounding_box.height}.jpg",img)

    def info(self):
        msg = QMessageBox()
        msg.setText("Emotion")
        msg.setInformativeText("GUI Emotion Detection using Tensorflow & Keras\nThis program was developed by Alireza Kiaeipour\nContact developer: a.kiaipoor@gmail.com\nBuilt in 2022")
